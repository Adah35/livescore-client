      ...
      <div className="w-12/12 mx-auto px-4 text-gray-700 font-semibold shadow-lg">
        <div className="flex items-center justify-between lg:justify-start gap-4 ">
          ...
          <div className=" space-x-4  relative hidden lg:flex ">
            <Link
              to={"/"}
              className="block  hover:text-blue-500 px-4 py-2 borderAnimation"
            >
              Live Scores
            </Link>
            <Link
            ...
            <Link className="block  hover:text-blue-500 px-4 py-2 borderAnimation">
              Transfers
            </Link>
            <Link className="block  hover:text-blue-500 px-4 py-2">Rumour</Link>
            <Link className="block  hover:text-blue-500 px-4 py-2">
              Prediction
            </Link>
            <Link className="block  hover:text-blue-500 px-4 py-2">
              Tipstar
          ...
          {model === false ? (
            <button
              className=" text-4xl lg:hidden text-white p-3 font-bold rounded-md"
            ...
            <button
              className=" text-white lg:hidden text-4xl p-3 font-bold rounded-md"
